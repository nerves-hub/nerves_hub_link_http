defmodule NervesHubLinkHTTP.CertificateTest do
  use ExUnit.Case, async: true
  alias NervesHubLinkHTTP.Certificate

  doctest Certificate

  describe "pem_to_der/1" do
    test "decodes certificate" do
      pem = File.read!(Path.join([:code.priv_dir(:nerves_hub_link_http), "ca_certs", "ca.pem"]))
